INSERT INTO User (url, password, name, email, address, lastLogin) VALUES ('user-1', 'pw1', 'User 1', 'user1@sharecare.com', 'Atlanta, GA', NULL);
INSERT INTO User (url, password, name, email, address, lastLogin) VALUES ('user-2', 'pw2', 'User 2', 'user2@sharecare.com', 'Atlanta, GA', NULL);
